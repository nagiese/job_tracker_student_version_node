...
General.clearContactForm = function(){
    Util.getEl('#name')[0].value = "";
    Util.getEl('#wphone')[0].value = "";
    Util.getEl('#mphone')[0].value="";
...
General.okayCancelMsg = function(){
    ...
    Util.msgBox({
        heading: {text: 'CAUTION', background: 'red'},
        body: {text: 'You are about to permently delete this records.  If that is what you want to do click "Okay" otherwise click "Cancel"'},
